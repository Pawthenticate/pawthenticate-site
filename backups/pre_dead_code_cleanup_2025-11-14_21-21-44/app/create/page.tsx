    ...
    try {
      ...
      if (vaccinationCertificate && vaccinationCertificate.dataUrl) {
        ...
        if (uploadResult.success && uploadResult.data) {
          ...
          vaccinationCertificate = uploadResult.data;  // Store as simple string URL
      ...
      if (desexingCertificate && desexingCertificate.dataUrl) {
        ...
        if (uploadResult.success && uploadResult.data) {
          // RADICAL SIMPLIFICATION: Just store the URL string, not the whole object
          desexingCertificate = uploadResult.data;  // Store as simple string URL
      ...
      <main id="main-content" className="flex-1 pt-24 px-4 sm:px-6 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    required
                  >
                    <option value="low">Low (Quiet, rarely makes noise)</option>
                    <option value="medium">Medium (Occasional barking/meowing)</option>
                    <option value="high">High (Regular vocalization)</option>
                  </select>
                </div>
            ...
            {/* Submit Button - Shows here if extended details are closed */}
            {!showExtendedDetails && (
              <div className="flex flex-col sm:flex-row gap-4 justify-between items-center pt-6">
                <Link 
                  href="/"
                  className="group px-8 py-4 text-base font-bold text-neutral-700 bg-white/90 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border-2 border-neutral-200 hover:border-primary-300 w-full sm:w-auto text-center"
                >
                ...
                <button
                  ...
                  className="group relative px-10 py-4 text-base font-black text-white rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none w-full sm:w-auto overflow-hidden"
                  style={{
            ...
            {/* Collapsible Extended Details Toggle Button */}
            <div className="relative py-8">
              ...
              <div className="relative flex justify-center">
                <button
                  ...
                  className="bg-gradient-to-br from-primary-50 via-secondary-50 to-primary-100 px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-105 border-2 border-white"
                >
                  ...
                  <p className="text-xs text-neutral-500 mt-1">Perfect for pet sitters, boarding & daycare</p>
                </button>
              </div>
            </div>
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  6. Landlord Reassurance <span className="text-neutral-400 text-sm font-normal">(Optional - for rentals)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  7. Feeding & Treats <span className="text-neutral-400 text-sm font-normal">(Optional)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  8. Health & Medications <span className="text-neutral-400 text-sm font-normal">(Optional)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  9. Daily Routine <span className="text-neutral-400 text-sm font-normal">(Optional)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  10. Exercise & Play <span className="text-neutral-400 text-sm font-normal">(Optional)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  11. Training & Commands <span className="text-neutral-400 text-sm font-normal">(Optional)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  12. Alone Time & Comfort <span className="text-neutral-400 text-sm font-normal">(Optional)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  13. Sleeping & House Rules <span className="text-neutral-400 text-sm font-normal">(Optional)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  14. Triggers & Safety <span className="text-neutral-400 text-sm font-normal">(Optional)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  15. Grooming & Handling <span className="text-neutral-400 text-sm font-normal">(Optional)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  16. Emergency Plan <span className="text-neutral-400 text-sm font-normal">(Optional)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            <section className="relative group">
              ...
              <div className="relative card bg-white/90 backdrop-blur-xl border-2 border-white/50">
                <h2 className="section-heading">
                  17. Extra Notes for Carer <span className="text-neutral-400 text-sm font-normal">(Optional)</span>
                </h2>
                <p className="text-sm text-neutral-600 mb-4">
            ...
            {/* Submit Button - Shows here if extended details are open */}
            {showExtendedDetails && (
              <div className="flex flex-col sm:flex-row gap-4 justify-between items-center pt-6">
                <Link 
                  href="/"
              ...
              <button 
                ...
                className="group relative px-10 py-5 text-lg font-bold text-white rounded-full shadow-2xl transform hover:scale-105 transition-all duration-300 overflow-hidden w-full sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
              >
                ...
                <span className="relative z-10 flex items-center justify-center gap-2">
                  {autoSaveStatus === 'saving' ? (
                    ...
                    <>
                      {petId ? 'Update Pet' : 'Save & Preview Resume'}
